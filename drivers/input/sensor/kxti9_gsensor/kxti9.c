...
struct kxti9_data {
	...
	int hw_initialized;
	atomic_t enabled;
//<ASUS-Darren1_Chang20120716+>
#ifdef CONFIG_ASUS_ENGINEER_MODE
	atomic_t enabledAccelConfig;
#endif
//<ASUS-Darren1_Chang20120716->
...
//<ASUS-Darren1_Chang20120627+>
#ifdef CONFIG_ASUS_ENGINEER_MODE
#include "asustag_kxti9_files.h"
#endif
//<ASUS-Darren1_Chang20120727->
...
//<ASUS-Darren1_Chang20130103+>
static int kxti9_drdy(struct kxti9_data *ti9)
{
	int err;
	u8 buf;

	err = kxti9_i2c_read(ti9, INT_STATUS_REG, &buf, 1);
	/*** DEBUG OUTPUT - REMOVE ***/
	/*dev_info(&ti9->client->dev, "INT_STATUS_REG = 0x%02x\n", buf);*/
...
static int kxti9_hw_init(struct kxti9_data *ti9)
{
	...
	if (err < 0)
		return err;
	buf[0] = (ti9->resume[RES_CTRL_REG1] | PC1_ON | DRDYE);	//<ASUS-Darren1_Chang20130103+>
	err = kxti9_i2c_write(ti9, CTRL_REG1, buf, 1);
	if (err < 0)
		return err;
...
#ifdef CONFIG_ASUS_ENGINEER_MODE
	&dev_attr_enAccelConfig.attr,	//<ASUS-Darren1_Chang20120716+>
#endif
	NULL
};
...
{
	struct kxti9_data *ti9 = i2c_get_clientdata(client);
	return !atomic_read(&ti9->enabled) ? kxti9_enable(ti9) : 0;
}

static int kxti9_suspend(struct i2c_client *client, pm_message_t mesg)
{
	struct kxti9_data *ti9 = i2c_get_clientdata(client);
	return atomic_read(&ti9->enabled) ? kxti9_disable(ti9) : 0;
}
