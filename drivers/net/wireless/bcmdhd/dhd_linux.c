...
{
//<ASUS-Darren1_Chang20121219->	int power_mode = PM_MAX;
	int power_mode = PM_FAST;	//<ASUS-Darren1_Chang20121219+>
...
dhd_watchdog_thread(void *data)
{
	...
	if (dhd_watchdog_prio > 0) {
		...
		/* Set "dhd_watchdog" to normal priority */
		/*
...
dhd_dpc_thread(void *data)
{
	...
	{
		struct sched_param param;
		/* Set "dhd_dpc" to normal priority */
...
dhd_preinit_ioctls(dhd_pub_t *dhd)
{
	...
	uint32 glom = 0;
	uint bcn_timeout = 20;//DHD_BEACON_TIMEOUT_NORMAL;
	//uint ampdu = 0;
	uint retry_max = 10;
...
//#if defined(WL_ENABLE_P2P_IF)
	...
	dhd_wl_ioctl_cmd(dhd, WLC_SET_VAR, iovbuf, sizeof(iovbuf), TRUE, 0);
        ...
        //bcm_mkiovar("ampdu", (char *)&ampdu, 4, iovbuf, sizeof(iovbuf));
        //dhd_wl_ioctl_cmd(dhd, WLC_SET_VAR, iovbuf, sizeof(iovbuf), TRUE, 0);
